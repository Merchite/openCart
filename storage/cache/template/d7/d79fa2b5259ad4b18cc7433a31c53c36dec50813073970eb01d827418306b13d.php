...
/* dashboard/view/template/tool/upgrade.twig */
class __TwigTemplate_9d362121cf3320b50e1307ab77d80cfce249ecb19f740dd6d60738de21a9472d extends Template
{
    private $source;
    private $macros = [];
...
\$('#button-upgrade').on('click', function () {
    ...
    var upgrade = function () {
        return \$.ajax({
            ...
            dataType: 'json',
            beforeSend: function () {
                \$('#button-upgrade').prop('disabled', true).addClass('loading');
            },
            success: function (json) {
                ...
                if (json['error']) {
                    ...
                    \$('#button-upgrade').prop('disabled', false).removeClass('loading');
                }
...
";
    ...
    {
        return "dashboard/view/template/tool/upgrade.twig";
    }
    ...
    {
        return new Source("", "dashboard/view/template/tool/upgrade.twig", "/var/www/html/opencart/upload/dashboard/view/template/tool/upgrade.twig");
    }
}
